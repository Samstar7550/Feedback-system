...
const FeedbackLayout = () => {
  ...
  return (
    <>
        <div className='flex h-screen w-screen flex-col gap-6 lg:flex-row md:flex-row px-3.5 py-5 lg:py-8 lg:px-16 md:py-4 md:px-8 items-center'>
            <section>
            ...
            <section className='flex h-full w-full items-center justify-center align-middle'>
             <Outlet/>
            </section>
        </div>
        <ToastContainer/>
